...
<html>
<head>
	<title>Thêm thương hiệu - ChronoLux Admin</title>
	<meta charset="utf-8">
	  ...
	  <div class="row">
	    ...
	    <div class="col-lg-10 col-md-9">
            <div class="admin-content" style="max-width: 600px;">
                <h2 class="section-title">Thêm thương hiệu mới</h2>
                ...
                <form method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="tenloai" placeholder="VD: Rolex, Omega..." required>
                    </div>
                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" name="themloai" class="btn btn-primary">Lưu thương hiệu</button>
